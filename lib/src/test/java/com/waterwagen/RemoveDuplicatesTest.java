...
public class RemoveDuplicatesTest {
  ...
  public void testRemoveDuplicates_Beginning() {
    // given
    int[] nums = {1,1,2,4,8,9};
    int[] expectedNums = {1,2,4,8,9};
  ...
  public void testRemoveDuplicates_End() {
    // given
    int[] nums = {1,4,8,9,12,12};
    int[] expectedNums = {1,4,8,9,12};
  ...
  public void testRemoveDuplicates_Multiple() {
    // given
    int[] nums = {1,4,4,8,8,9,9};
    int[] expectedNums = {1,4,8,9};
  ...
  private static void testRemoveDuplicates(int[] nums, int[] expectedNums) {
    // when
    int uniqueElementCount = Study.RemoveDuplicatesSolution.removeDuplicates(nums);
